...
?>
  ...
  <div id="header-wrapper">
    <div id="header"><div class="section clearfix grid_12">
    ...
    <div id="content-wrapper">
      <div id="content" class="column grid_12"><div class="section">
        ...
        <?php #print $feed_icons; ?>
         <?php if ($page['content-col1']): ?>
        <div id="content-col1" class="column grid_6 alpha"><div class="section">
          <?php print render($page['content-col1']); ?>
        </div></div> <!-- /.section, /#sidebar-first -->
      <?php endif; ?>

      <?php if ($page['content-col2']): ?>
        <div id="content-col2" class="column grid_6 omega"><div class="section">
          <?php print render($page['content-col2']); ?>
